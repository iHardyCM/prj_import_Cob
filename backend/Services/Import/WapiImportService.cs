...
{
    public class WapiImportService : IChannelImportService
    {
        private readonly IConfiguration _cfg;
        public WapiImportService(IConfiguration cfg) => _cfg = cfg;
        public ChannelType channel => ChannelType.Wapi;
        ...
        public async Task<ImportResult> ImportAsync(int idCartera, IFormFile file, string? usuario, CancellationToken ct = default)
        {
            ...
            using (var wb = new XLWorkbook(stream))
            {
                ...
                if (!headers.TryGetValue("dni", out int cDni) ||
                    ...
                    throw new InvalidOperationException("Cabeceras: DNI, TELEFONO, MENSAJE.");
                ...
                foreach (var row in ws.RowsUsed().Skip(1))
                {
                    ...
                    if (string.IsNullOrWhiteSpace(dni) &&
                        ...
                        string.IsNullOrWhiteSpace(msg)) continue;
            ...
            using var cmd = new SqlCommand("dbo.Importar_CampaignWAPI", conn) { CommandType = CommandType.StoredProcedure };
            ...
            p.TypeName = "dbo.ESTRUCTURA_WAPI";
